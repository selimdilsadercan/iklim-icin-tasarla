...
export const AdminProtectedRoute: React.FC<AdminProtectedRouteProps> = ({
  ...
  const { user, loading, isAdmin, isTeacher, userRole } = useAuth();
  ...
  useEffect(() => {
    ...
    if (!loading && (!user || (!isAdmin && !isTeacher))) {
      ...
      // Redirect users who are not admin or teacher to home
      router.push("/home");
    }
  }, [user, loading, isAdmin, isTeacher, userRole, router]);
          ...
          <div className="w-16 h-16 bg-yellow-100 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            >
              <path
                ...
                strokeWidth={2}
                d="M12 8v4l4 4m6 0a9 9 0 11-18 0 9 9 0 0118 0z"
              />
            </svg>
          </div>
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
        <div className="text-center p-8 bg-white/80 rounded-2xl shadow-lg border border-gray-200 max-w-md mx-4">
          ...
          <p className="text-gray-600 mb-6">
            Bu sayfaya erişim için yönetici veya öğretmen yetkilerine sahip
            olmanız gerekiyor.
          </p>
          <button
